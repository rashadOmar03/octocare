...
class AdminCreateReceptionistScreen extends StatefulWidget {
  const AdminCreateReceptionistScreen({super.key});

  @override
  State<AdminCreateReceptionistScreen> createState() => _AdminCreateReceptionistScreenState();
}

class _AdminCreateReceptionistScreenState extends State<AdminCreateReceptionistScreen> {
  ...
  Future<void> _create() async {
    ...
    try {
      final result = await _service.createReceptionist({
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text(AppLocalizations.tr('create_receptionist'))),
